...
namespace NHibernate.AspNet.Identity
{
    ...
    public class UserStore<TUser> : IUserLoginStore<TUser>, IUserClaimStore<TUser>, IUserRoleStore<TUser>, IUserPasswordStore<TUser>, IUserSecurityStampStore<TUser>, IQueryableUserStore<TUser>, IUserStore<TUser>, IUserLockoutStore<TUser, string>, IUserEmailStore<TUser>, IUserPhoneNumberStore<TUser>, IUserTwoFactorStore<TUser, string>, IDisposable where TUser : IdentityUser
    {
        ...
        public UserStore(INHibernateProviderFactory nHibernateProviderFactory)
        {
        ...
        public virtual Task CreateAsync(TUser user)
        {
            ...
            {
                NHibernateProviderFactory.Current.Session.Save(user);
        ...
        public virtual Task DeleteAsync(TUser user)
        {
            ...
            using (NHibernateProviderFactory.Start())
            {
                NHibernateProviderFactory.Current.Session.Delete(user);
                NHibernateProviderFactory.Current.TransactionalFlush();
            }
        ...
        public virtual Task UpdateAsync(TUser user)
        {
            ...
            using (NHibernateProviderFactory.Start())
            {
                NHibernateProviderFactory.Current.Session.Update(user);
                NHibernateProviderFactory.Current.TransactionalFlush();
            }
        ...
        {
            if (disposing && NHibernateProviderFactory != null && this.ShouldDisposeSession)
            {
        ...
        public virtual Task<TUser> FindAsync(UserLoginInfo login)
        {
            ...
            using (NHibernateProviderFactory.Start())
            {
                var query = from u in NHibernateProviderFactory.Current.Session.Query<TUser>()
                            from l in u.Logins
        ...
        public virtual Task AddLoginAsync(TUser user, UserLoginInfo login)
        {
            ...
            using (NHibernateProviderFactory.Start())
            {
                NHibernateProviderFactory.Current.Session.SaveOrUpdate(user);
                NHibernateProviderFactory.Current.TransactionalFlush();
            }
